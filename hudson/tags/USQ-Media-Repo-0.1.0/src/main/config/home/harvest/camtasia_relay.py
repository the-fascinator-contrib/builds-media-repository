...
class IndexData:
    ...
    def __workflow(self):
        ...
        try:
            ...
            if formData is not None:
                ...
                course = formData.get("course_code")
                if course:
                    self.item_security.add(course)
                # Course security - moodle
                moodle_courses = formData.get("moodleSecurity")
                if moodle_courses:
                ...
                psMoodle_courses = formData.get("psMoodle")
                if psMoodle_courses:
            ...
            wfMeta.set("pageTitle", "Camtasia Relay Files - Management")
            if self.relayTitle is not None:
                wfMeta.set("formData/title", self.relayTitle)
            if self.relayDescription is not None:
                wfMeta.set("formData/description", self.relayDescription)
    ...
    def __getEmailBody(self, index):
        ...
        body = self.config.get("camtasia/" + index)
