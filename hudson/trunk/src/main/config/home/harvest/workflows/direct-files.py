...
class IndexData:
    ...
    def __workflow(self):
        ...
        try:
            ...
            print "  step='%s'" % wfMeta.getString(None, ["step"])
            ...
            print "No workflow playload - time to create (step=pending)"
        ...
        # Copyright Notices
        wfCopyright = wfMeta.getString(None, ["copyright"]);
        if wfCopyright is not None and wfCopyright == "true":
            wfNotice = wfMeta.getString(None, ["copyrightNotice"]);
        ...
        self.wfSecurityExceptions = wfMeta.getString(None, ["directSecurityExceptions"]);
        #
    ...
    def __storeAndIndex(self, field, value):
        if value is not None and value != "":
            ...
            self.directIndex.getJsonObject().put(field, value)
